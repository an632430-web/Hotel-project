  ...
  return (
    ...
    pt-20 pb-30">
        <div className="flex flex-col md:flex-row items-center justify-between w-full">
            ...
            <button className="grpup flex items-center gap-2 font-medium cursor-pointer max-md:mt-12">View All Offers
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12 ">
            {exclusiveOffers.map((item)=>(
                ...
                style={{ backgroundImage:`url(${item.image})` }}>
                        ...
                        text-gray-800 font-medium rounded-full">{item.priceOff}%</p>
                        <div>
                        ...
                        <button className="flex items-center gap-2 font-medium cursor-pointer mt-4 mb-5 ">
                            View Offers
                            <img src={assets.arrowIcon} className="invert group-hover:translate-x-1 
                            transition-all"/>
                        </button>
