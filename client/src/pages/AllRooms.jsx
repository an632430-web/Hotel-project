        ...
        <div>
            ...
            {roomsDummyData.map((room)=>(
                ...
                border-b border-gray-300 last:pb-30 last:border-0">
                    <img onClick={()=>{navigate(`/rooms/${room._id}`);scrollTo(0,0)}} src={room.images[0]} alt="room image" title="view room details" 
                    ...
                    <div className="md:w-1/2 flex flex-col gap-2">
                        ...
                        <p className="text-xl font-medium text-gary-700">
            ...
            <div className={`${openFilters ? 'h-auto' :'h-0 lg:h-auto'} overflow-hidden transition-all duration-700`}>
                ...
                <div className="px-5 pt-5 pb-7">
                    ...
                    {sortOptions.map((type,index)=>(
                        <RadioButton label={type} key={index}/>
