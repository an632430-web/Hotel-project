...
export const Dashboard = () => {
  ...
  return (
    <div>
        <Title align={'left'} title={'Dashboard'} font={'outfit'} subTitle={'monitor your room listings, track bookings and analyze revenue--all in one place. stay updated with real time insights to ensure smooth operations'}/>
